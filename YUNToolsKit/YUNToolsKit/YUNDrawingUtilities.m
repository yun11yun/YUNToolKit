...
CGFloat YUNFLimit(CGFloat f, CGFloat min, CGFloat max) {
...
void YUNDrawRoundedRect(CGContextRef context, CGRect rect, CGFloat cornerRadius) {
...
CGGradientRef YUNCreateGradientWithColors(NSArray *colors) {
    return YUNCreateGradientWithColorsAndLocations(colors, nil);
}


CGGradientRef YUNCreateGradientWithColorsAndLocations(NSArray *colors, NSArray *locations) {
...
void YUNDrawGradientInRect(CGContextRef context, CGGradientRef gradient, CGRect rect) {
