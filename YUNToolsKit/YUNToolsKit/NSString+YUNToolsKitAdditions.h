//
//  NSString+YUNToolsKitAdditions.h
//  YUNToolsKit
//
...
@interface NSString (YUNToolsKitAdditions)

/**
 *  Returns a string of the MD5 sum of the receiver.
 *
 *  @return The string of the MD5
 */
- (NSString *)MD5Sum;
 ...
 *
 *  The following characters are escaped: '\n\r:/=,!$&'()*+;[]@#?%'. Spaces are escaped to the '+' character. ('+' is escaped to '%2B').
 *
 ...
 *
 *  This uses 'NSData' 'dataWithBase64String:' method to do the conversion then initializes a string with the resulting
