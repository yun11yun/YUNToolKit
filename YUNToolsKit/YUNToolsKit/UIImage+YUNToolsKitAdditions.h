//
//  UIImage+YUNToolsKitAdditions.h
//  YUNToolsKit
//
 ...
 */
@interface UIImage (YUNToolsKitAdditions)
...
/**
 ...
 The length of the sides of square are the length of the shorttest side of the image.
