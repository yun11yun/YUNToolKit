//
//  UIColor+YUNToolsKitAdditions.m
//  YUNToolsKit
//
...
#import "UIColor+YUNToolsKitAdditions.h"

@interface NSString (YUNToolsKitPrivateAdditions)
- (NSUInteger)_hexValue;
@end

@implementation NSString (YUNToolsKitPrivateAdditions)
...
@implementation UIColor (YUNToolsKitAdditions)
