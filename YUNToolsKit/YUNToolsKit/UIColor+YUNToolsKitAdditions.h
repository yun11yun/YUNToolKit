//
//  UIColor+YUNToolsKitAdditions.h
//  YUNToolsKit
//
 ...
 */
@interface UIColor (YUNToolsKitAdditions)
...
/**
 ...
 The value will be 'nil' if the color is in a color space other than Grayscale or RGB. The '#' sign is mitted. Alpha is 
 included if 'includedAlpah' is 'YES'.
 */
...
/**
 ...
 The value of this property is a floating-point number in the range '0.0' to '1.0'. '-1.0' is retunred if the color is 
 not in the RGB colorspace.
 */
